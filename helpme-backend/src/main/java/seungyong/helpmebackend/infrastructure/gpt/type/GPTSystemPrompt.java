...
public final class GPTSystemPrompt {
    ...
    public static final String EVALUATION_PROMPT = """
            ...
            1. 긍정적인 측면과 개선이 필요한 측면을 모두 언급해야해.
            2. README.md 내용의 강점과 약점을 명확하게 지적해야해.
            3. 긍정적인 피드백과 건설적인 비판을 균형 있게 제공해야해.
            4. 사용자가 쉽게 이해할 수 있도록 명확하고 간결하게 작성해야해.
            5. 피드백이 평가 점수와 일관되도록 해야해.
            6. 피드백이 프로젝트의 특성과 목적에 적합하도록 해야해.
            7. 피드백이 실질적인 도움이 될 수 있어야해.
            8. 피드백은 전문적이고 신뢰할 수 있어야해.
            9. 피드백이 긍정적인 동기를 부여할 수 있어야해.
            10. 피드백이 전체적인 평가와 조화를 이루도록 해야해.
            11. 피드백을 작성할 때는 앞에 "개선 :", "장점 :"과 같이 항목을 구분해서 작성해야해.
            12. 전체적인 종합 평가, 우선 권장 작업 등 위에서 이야기한 내용을 다시 요약하는 내용은 작성하지 않아야해.
