...
import seungyong.helpmebackend.repository.adapter.out.gpt.dto.GPTDraftReadmeGenerationSchema;
import seungyong.helpmebackend.repository.adapter.out.gpt.dto.GPTEvaluationSchema;
import seungyong.helpmebackend.repository.adapter.out.gpt.dto.GPTRepositoryAnalyzeSchema;
import seungyong.helpmebackend.repository.adapter.out.gpt.dto.PromptContext;
import seungyong.helpmebackend.repository.application.port.out.result.*;
import seungyong.helpmebackend.repository.domain.type.GPTSystemPrompt;
